...
- Python 3.10+
- RoboCasa and robosuite installed (already set up in this repo)
- MuJoCo 3.3.1
- A GPU with >= 8 GB VRAM for training (24 GB+ recommended)
- For Mac users: use `mjpython` instead of `python` for rendering scripts
